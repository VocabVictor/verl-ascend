...
if __name__ == '__main__':
    import torch
    from verl.llm import InferRequest, get_model_tokenizer, get_template
    from verl.utils import set_default_ddp_config
    from verl.megatron.argument import MegatronArguments
    from verl.megatron.model import get_megatron_model_meta
    from verl.megatron.utils import patch_megatron_tokenizer
    # test_bf16_fp32()
