...
def test_sft():
    # verl/SlimOrca  verl/cosmopedia-100k
    # _test_dataset(['lvjianjin/AdvertiseGen'])
    # _test_dataset(['AI-ModelScope/Duet-v0.5'])
    # _test_dataset(['verl/SlimOrca', 'verl/cosmopedia-100k'])
    ...
    # _test_dataset(['verl/Infinity-Instruct:all'])
    # _test_dataset(['verl/sharegpt:all'])
    # _test_dataset(['AI-ModelScope/sharegpt_gpt4:all'])
    # _test_dataset(['iic/ms_bench'])
    # _test_dataset(['verl/tagengo-gpt4'])


def test_mllm():
    # _test_dataset(['AI-ModelScope/ShareGPT4V:all'])
    # _test_dataset(['AI-ModelScope/LLaVA-Pretrain'])
    # _test_dataset(['verl/TextCaps'])
    # _test_dataset(['verl/RLAIF-V-Dataset:all'])
    # _test_dataset(['verl/OK-VQA_train'])
    # _test_dataset(['verl/OCR-VQA'])
    # _test_dataset(['verl/A-OKVQA'])
...
def test_dataset_info():
    _test_dataset(['verl/self-cognition#500'], model_name='xiao huang', model_author='verl')
