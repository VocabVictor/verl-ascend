...
from verl.llm import MODEL_MAPPING, load_dataset
            ...
            for group in model_meta.model_groups:
                ...
                try:
                    ...
                    if os.system(cmd) != 0:
                        raise RuntimeError()
                    cmd = (
                        'CUDA_VISIBLE_DEVICES=0 PYTHONPATH=/mnt/workspace/yzhao/tastelikefeet/verl python tests/llm/load_template.py '  # noqa
