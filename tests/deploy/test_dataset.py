def _test_client(port=8000):
    import time
    import aiohttp
    from verl.llm import InferClient, InferRequest, RequestConfig, load_dataset, run_deploy
...
def _test(infer_backend):
    ...
    from verl.llm import DeployArguments
    from verl.llm import run_deploy
