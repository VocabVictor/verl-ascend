...
from verl import AdaLoraConfig, LoraConfig, LoRAConfig, Verl, get_peft_model
...
class TestPeft(unittest.TestCase):
    ...
    def test_lora_merge(self):
        ...
        model = Verl.prepare_model(model, {'second': lora_config2})
        ...
        model3 = Verl.from_pretrained(model3, self.tmp_dir)
