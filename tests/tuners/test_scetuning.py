...
from verl import SCETuningConfig, Verl
from verl.tuners.part import PartConfig
...
class TestSCETuning(unittest.TestCase):
    ...
    def test_scetuning_on_diffusers_v1(self):
        ...
        model = Verl.prepare_model(model, config=scetuning_config)
        ...
        model_check = Verl.from_pretrained(model_check, self.tmp_dir)
