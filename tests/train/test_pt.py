...
def test_llm():
    from verl.llm import pt_main, TrainArguments, infer_main, InferArguments
    result = pt_main(
        TrainArguments(
            model='Qwen/Qwen2-7B-Instruct', dataset=['verl/sharegpt:all#100'], split_dataset_ratio=0.01, **kwargs))
