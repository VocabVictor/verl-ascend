...
# Temporary import wrapper for Swift integration
# TODO: Replace with native VERL implementations
try:
    ...
    raise ImportError(f"Swift integration required: {e}. Please ensure Swift is installed.")
...
class VerlSft(SwiftPipeline, TunerMixin):
    ...
    def _prepare_generation_config(self):
        ...
        # Simplified generation config for VERL SFT
        ...
        pass  # Skip generation config for now
    ...
    def _prepare_model_tokenizer(self):
        ...
        if args.sequence_parallel_size > 1:
            try:
                from ...parallel import sequence_parallel
                sequence_parallel.init_sequence_parallel(args.sequence_parallel_size)
            except ImportError:
                logger.warning("Sequence parallel not available in this configuration.")
