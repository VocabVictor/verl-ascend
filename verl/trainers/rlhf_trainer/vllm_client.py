...
from verl.llm import AdapterRequest, RolloutInferRequest, Template
from verl.llm.infer.protocol import (ChatCompletionResponse, GymRolloutResponseChoice, RequestConfig,
                                      RolloutResponseChoice)
from verl.plugin import Metric
from verl.utils import is_vllm_ascend_available, is_vllm_available
            ...
            try:
                ...
                if elapsed_time >= total_timeout:
                    raise ConnectionError(
                        ...
                        'sure the server is running by running `verl rollout`.') from exc
            else:
