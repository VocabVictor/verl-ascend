...
from .arguments import GRPOArgumentsMixin, VerlArgumentsMixin


@dataclass
class DPOConfig(VerlArgumentsMixin, HfDPOConfig):
    pass


@dataclass
class CPOConfig(VerlArgumentsMixin, HfCPOConfig):
    pass


@dataclass
class ORPOConfig(VerlArgumentsMixin, HfORPOConfig):
    pass


@dataclass
class KTOConfig(VerlArgumentsMixin, HfKTOConfig):
    pass


@dataclass
class RewardConfig(VerlArgumentsMixin, HfRewardConfig):
    pass


@dataclass
class PPOConfig(VerlArgumentsMixin, HfPPOConfig):
    pass


@dataclass
class GKDConfig(VerlArgumentsMixin, HfGKDConfig):
    pass


@dataclass
class GRPOConfig(GRPOArgumentsMixin, VerlArgumentsMixin, HfGRPOConfig):
    ...
    def __post_init__(self):
        ...
        if self.deepspeed and 'zero_optimization' in self.deepspeed and self.deepspeed['zero_optimization'][
                'stage'] == 3:
            # https://github.com/modelscope/ms-verl/issues/3237
        ...
        # https://github.com/modelscope/ms-verl/issues/3863
