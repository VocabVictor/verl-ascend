...
from verl.trainers.optimizers.galore import create_optimizer_and_scheduler
from verl.utils import get_dist_setting

if TYPE_CHECKING:
    from verl.trainers import TrainingArguments
...
def create_muon_optimizer(args: 'TrainingArguments', model, dataset):
    from verl.llm import git_clone_github, get_model_arch
...
def create_multimodal_optimizer(args: 'TrainingArguments', model, dataset):
    ...
    from verl.llm import get_model_arch
