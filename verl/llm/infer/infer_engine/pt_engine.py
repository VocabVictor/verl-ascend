...
from verl.llm import InferRequest, Template, TemplateMeta, get_model_tokenizer, safe_snapshot_download, to_device
...
class PtEngine(InferEngine):
    ...
    def _add_adapter(self, adapter_path: str, adapter_name: Optional[str] = None) -> None:
        self.model = Verl.from_pretrained(self.model, adapter_path, adapter_name)
