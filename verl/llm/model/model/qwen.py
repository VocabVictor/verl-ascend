...
from verl.utils import get_device_count, get_dist_setting, get_env_args, get_logger
    ...
    ModelMeta(
        ...
        [
            ModelGroup([
                ...
                # awq
                Model('verl/Qwen3-30B-A3B-AWQ', 'cognitivecomputations/Qwen3-30B-A3B-AWQ'),
                Model('verl/Qwen3-235B-A22B-AWQ', 'cognitivecomputations/Qwen3-235B-A22B-AWQ'),
            ]),
        ],
        TemplateType.qwen3,
        get_model_tokenizer_with_flash_attn,
...
def patch_qwen_vl_utils(vision_process):
    ...
    def _new_read_video_decord(ele: dict):
        from verl.llm import load_file
