...
from verl.utils import get_dist_setting, get_logger, is_mp, is_unsloth_available, patch_getattr, use_torchacc
...
def get_model_tokenizer_from_local(model_dir: str,
    ...
    if load_model:
        ...
        if model_info.task_type == 'embedding' and automodel_class.__name__ != 'AutoModel':
            from verl.llm.model.patcher import patch_output_normalizer
