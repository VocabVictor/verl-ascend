...
from verl.llm import ExportArguments, VerlPipeline
from verl.tuners import verl_to_peft_format
...
class VerlExport(VerlPipeline):
    ...
    def run(self):
        ...
        if args.to_peft_format:
            args.adapters[0] = verl_to_peft_format(args.adapters[0], args.output_dir)
        if args.merge_lora:
        ...
        if args.quant_method:
            ...
            from verl.megatron import convert_hf2mcore
            convert_hf2mcore(args)
        elif args.to_hf:
            from verl.megatron import convert_mcore2hf
