...
from verl.llm import MODEL_MAPPING, HfConfigFactory, get_model_info_meta, get_model_name
from verl.utils import get_dist_setting, get_logger
...
class ModelArguments:
    ...
    def _init_torch_dtype(self) -> None:
        ...
        from verl.llm import TrainArguments
