...
from verl.llm import ExportArguments
from verl.ui.base import BaseUI
from verl.ui.llm_export.export import Export
from verl.ui.llm_export.model import Model
from verl.ui.llm_export.runtime import ExportRuntime
from verl.utils import get_device_count
...
class LLMExport(BaseUI):
    ...
    def export(cls, *args):
        ...
        if sys.platform == 'win32':
            ...
            run_command = f'{cuda_param}{additional_param}start /b verl export {params} > {log_file} 2>&1'
        else:
            run_command = f'{cuda_param} {additional_param} nohup verl export {params} > {log_file} 2>&1 &'
