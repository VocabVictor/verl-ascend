...
from verl.llm import TEMPLATE_MAPPING, ModelType, SamplingArguments
from verl.llm.model.register import get_all_models
...
class Model(BaseUI):
    ...
    locale_dict = {
        'model_type': {
            ...
            'info': {
                'zh': 'VERL已支持的模型类型，model是服务名称时请置空',
                'en': 'Base model type supported by VERL, Please leave it blank if model is the service name'
            }
        },
        'model': {
            'label': {
