...
from verl.llm import SamplingArguments
from verl.llm.dataset.register import get_dataset_list
from verl.ui.base import BaseUI
from verl.ui.llm_sample.model import Model
from verl.ui.llm_sample.runtime import SampleRuntime
from verl.ui.llm_sample.sample import Sample
...
class LLMSample(BaseUI):
    ...
    def sample(cls, *args):
        ...
        if sys.platform == 'win32':
            ...
            run_command = f'{cuda_param}start /b verl sample {params} > {log_file} 2>&1'
        else:
            run_command = f'{cuda_param} nohup verl sample {params} > {log_file} 2>&1 &'
