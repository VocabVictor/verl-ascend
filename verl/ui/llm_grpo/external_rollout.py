...
from verl.llm import DeployArguments, RLHFArguments, RolloutArguments
from verl.ui.base import BaseUI
from verl.ui.llm_grpo.external_runtime import RolloutRuntime
...
class LLMRollout(BaseUI):
    ...
    def rollout(cls, *args):
        ...
        if sys.platform == 'win32':
            ...
            run_command = f'{cuda_param}start /b verl rollout {params} > {log_file} 2>&1'
        else:
            run_command = f'{cuda_param} nohup verl rollout {params} > {log_file} 2>&1 &'
