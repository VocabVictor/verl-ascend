...
from verl.utils import JsonlWriter, deep_getattr, get_logger, is_master
from ..utils import adapter_state_dict_context, copy_original_module_weight, prepare_mcore_model
from .utils import get_verl_datasets_provider
...
class BaseMegatronTrainer(ABC):
    ...
    def train(self, train_dataset, val_dataset, data_collator):
        args = self.args
        datasets_provider = get_verl_datasets_provider(train_dataset, val_dataset)
