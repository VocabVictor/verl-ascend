...
from verl.utils import JsonlWriter, get_logger, is_master, is_megatron_available, safe_ddp_context, subprocess_run
...
def _patch_megatron():
    ...
    from verl.megatron import tuners  # patch lora
    try:
